...
TBitField TBitField::operator~(void) // отрицание												 //zzzzzzzzzzzzz
{																								 //zzzzzzzzzzzzz
	TBitField tmp(*this);																		 //zzzzzzzzzzzzz
	for (int i = 0; i < BitLen; i++) {															 //zzzzzzzzzzzzz
		if (tmp.GetBit(i))																		 //zzzzzzzzzzzzz
			tmp.ClrBit(i);																		 //zzzzzzzzzzzzz
		else																					 //zzzzzzzzzzzzz
			tmp.SetBit(i);																		 //zzzzzzzzzzzzz
	}																							 //zzzzzzzzzzzzz
	return tmp;																					 //zzzzzzzzzzzzz
}
